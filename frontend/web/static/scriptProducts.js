...
function orderProducts() {
  ...
  productRows.forEach(row => {
    ...
    //  const priceCell = row.querySelector('td:nth-child(3)'); // Asegúrate de que esta celda tenga el precio
      //const price = parseFloat(priceCell.textContent); // Convertir el precio a número decimal
